...
class TestCrossEntropy(unittest.TestCase):
    ...
    def test_forward(self) -> None:
        ...
        for test_case in test_cases:
            ...
            self.assertTrue(
                ...
                f"forward function does not calculate the correct outputs for predictions {test_case['predictions'].elements} and targets {test_case['targets'].elements}",
            )
    ...
    def test_backward(self) -> None:
        ...
        for test_case in test_cases:
            ...
            self.assertTrue(
                np.allclose(
                    test_case['predictions'].deltas,
                    test_case['expected_output'],
                    rtol=1e-05,
                    atol=1e-08,
                ),
                f"backward function does not calculate the correct outputs for predictions {test_case['predictions'].elements} and targets {test_case['targets']}",
            )
    ...
    def test_backward(self) -> None:
        ...
        for test_case in test_cases:
            ...
            self.assertTrue(
                ...
                f"backward function does not calculate the correct outputs for predictions {test_case['predictions'].elements} and targets {test_case['targets'].elements}",
            )
